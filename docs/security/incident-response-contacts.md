...
| 部署/基礎設施 | GitHub Pages、DNS、密鑰輪替 | 單人維運者 | service@yao.care | 私有 ISMS |
| 對外/法遵 | 通知收案機構、法遵溝通 | 單人維運者 | service@yao.care | 私有 ISMS |

> ⚠️ **單點風險（部分緩解）**：四個角色集中於一人。`service@yao.care` 為**受監控
> 的角色信箱**，作為通報入口；但仍**無第二名人類備援**。建議指定一名備援聯絡人
> （在主維運者失聯時觸發回滾/通知），明細納入私有 ISMS。
...
| 收案機構（FHIR 資料接收方） | 涉上傳資料風險時通知 | **GCM 協會**及其他合作醫院；窗口明細見私有 ISMS。註：上傳為**選用**，客戶可選擇不收案（資料僅留瀏覽器端） |
